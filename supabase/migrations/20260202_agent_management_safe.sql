-- ============================================================
-- Plexify Agent Management — Sprint 2 MVP Schema (SAFE VERSION)
-- Handles re-runs by dropping indexes/triggers first if they exist
-- ============================================================
...
DROP INDEX IF EXISTS idx_agents_product_line;
...
DROP INDEX IF EXISTS idx_templates_agent_id;
...
DROP INDEX IF EXISTS idx_session_agents_agent;
...
DROP TRIGGER IF EXISTS templates_updated_at ON prompt_templates;
DROP TRIGGER IF EXISTS sessions_updated_at ON agent_sessions;
