    ...
    >
      ...
      <div className={`relative aspect-[4/3] rounded-lg bg-gradient-to-br ${gradient} border border-white/10 overflow-hidden flex items-center justify-center`}>
        ...
        {artifact.status === 'generating' && (
          <div className="absolute top-1 right-1 px-1.5 py-0.5 rounded text-[10px] bg-amber-500/80 text-white">
            Generating...
          </div>
        )}
      </div>
      ...
      <div className="mt-1.5">
        <p className="text-xs text-white/80 truncate">{artifact.title}</p>
        {artifact.subtitle && (
